...
<head id="Head1">
    ...
    <script type="text/javascript" src='/resources/js/XiuCai.index.js'></script>
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 50px;
     background: url(/resources/images/layout-browser-hd-bg.gif) #7f99be repeat-x center 100%;
...
<div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
    <div class="footer">By RayKing Manchey(曼奇) China</div>
</div>
...
<div region="center" id="mainPanle" style="background: #eee; overflow-y:hidden">
    <div id="tabs" class="easyui-tabs" fit="true" border="false">
        <div title="欢迎使用" style="padding:20px;overflow:hidden; color:red; ">
            <h1 style="font-size:24px;">* 作者：RayKing QQ：371929908</h1>
            <h1 style="font-size:24px;">* BLOG: <a style="font-size:24px;color:green;" href="http://blog.swroom.com">三问笔记</a>
            </h1>
        </div>
    </div>
</div>
