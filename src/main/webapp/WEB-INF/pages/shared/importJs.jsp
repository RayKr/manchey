<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
<script src="<c:url value='/assets/plugins/respond.min.js'/>" type="text/javascript"></script>
<script src="<c:url value='/assets/plugins/excanvas.min.js'/>" type="text/javascript"></script>
<![endif]-->
...
<script src="<c:url value='/assets/plugins/bootstrap-hover-dropdown/twitter-bootstrap-hover-dropdown.min.js'/>" type="text/javascript" ></script>
...
<script src="<c:url value='/assets/plugins/jquery.cookie.min.js'/>" type="text/javascript"></script>
